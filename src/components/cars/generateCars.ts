...
<div class='carWrapper'>
   <div class='carButtonsAndName'>
      <div class='carAddRemoveButtons'>
         <button class='carSelect'>SELECT</button>
